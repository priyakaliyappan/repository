		...
		// TODO Auto-generated method stub
			Connection conn;
			  ...
			  Class.forName("oracle.jdbc.OracleDriver");
			   ...
			   result = stmt.executeUpdate("delete from student where roll_no=43");  //we are using executeUpdate here which will return true or false value hence the variable used for string that must be of type int not resultset
