...
public class Recordsrangeabove {
		public static void main(String[] args) {
						...
						Connection conn;
						  ...
						  Class.forName("oracle.jdbc.OracleDriver");
						   ...
						   rs = stmt.executeQuery("select * from student where salary>4000");  //we are using executeUpdate here which will return true or false value hence the variable used for string that must be of type int not resultset
